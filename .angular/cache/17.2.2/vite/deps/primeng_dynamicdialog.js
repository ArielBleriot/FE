...
function DynamicDialogComponent_div_2_div_3_ng_container_3_button_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngClass", ɵɵpureFunction0(6, _c4));
    ɵɵadvance();
...
function DynamicDialogComponent_div_2_div_3_ng_container_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("id", ctx_r13.ariaLabelledBy);
    ɵɵadvance();
...
function DynamicDialogComponent_div_2_div_8_ng_container_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵtextInterpolate1(" ", ctx_r33.config.footer, " ");
  }
}
...
function DynamicDialogComponent_div_2_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(2, DynamicDialogComponent_div_2_div_8_ng_container_2_Template, 2, 1, "ng-container", 9)(3, DynamicDialogComponent_div_2_div_8_ng_container_3_Template, 1, 0, "ng-container", 10);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function DynamicDialogComponent_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("@animation.start", function DynamicDialogComponent_div_2_Template_div_animation_animation_start_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r35.onAnimationStart($event));
      ...
      return ɵɵresetView(ctx_r37.onAnimationEnd($event));
    });
    ...
    ɵɵelementEnd();
    ɵɵtemplate(8, DynamicDialogComponent_div_2_div_8_Template, 4, 2, "div", 11);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
var _c8 = (a1, a2, a3, a4, a5, a6, a7, a8, a9) => ({
  "p-dialog-mask": true,
